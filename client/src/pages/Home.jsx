...
export default function Home() {
  ...
  return (
    ...
    <section className='mx-5 md:container md:mx-auto md:px-48 mt-10 mb-10'>
      <div>
        <h1 className='font-extrabold text-3xl'>Welcome to the Community Gallery</h1>
        <p className='mt-2 text-gray-500 text-xl'>Explore a collection of imaginative and visually stunning images created by ImagineMate. Share your boundless imagination and artistic flair with others.</p>
      </div>
      <div className='mt-12'>
                ...
                {search ? (
                  searchResult.length > 0 ? (
                    ...
                    <div className="w-full h-96">
                      <h1 className='text-red-600'>No Search result Found</h1>
                    </div>
                  )
                ) : (
                  allList.length > 0 && (
      ...
      </div>
      {
        paginate.total_data > paginate.per_page && (
          <div className="join mt-20 container mx-auto justify-center mb-16">
